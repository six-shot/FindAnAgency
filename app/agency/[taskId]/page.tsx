  ...
  return (
    <>
      <div className="max-w-[1440px] mx-auto px-5 pb-10">
        <h2 className="xl:text-[60px] text-[40px] border-b-[1px] border-black">{task.name}</h2>
        <div>
          <div className="flex xl:flex-row flex-col xl:items-center gap-5 mt-10">
          ...
          <div className="flex xl:flex-row flex-col items-center gap-5 xl:mt-10 mt-3">
